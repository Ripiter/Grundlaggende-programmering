...
namespace Word_H1
{
    class Gaet__et_tal
    {
        ...
        //            int Randomnum = Rranom.Next(1, 11); //Generates new random number inside of the loop
        //            chance = Randomnum;
        //            wrong = 0;                          //Resets the wrong counter
        //        }
        //        Console.WriteLine("Press enter to play again");


        //    } while (Console.ReadLine() == "");         //Plays loop again after pressing Enter
        //}
    }
}
